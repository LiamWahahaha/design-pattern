...
# Abstract Factory solves the problem of creating entire product families
# without specifying their concrete classes. It defines an interface for
# creating all distinct products but leaves the actual product creation
# to concrete factory classes. Each factory type corresponds to a certain
# product variety.

# The client code calls the creation methods of a factory object instead of
# creating products directly with a constructor call (new operator). Since
# a factory factory cooresponds to a single product variant, all its products
# will be compatible.

# Client code works with factories and products only through their abstract
# interfaces. It allows the same client code to work with different products.
...
class AbstractFactory(ABC):
    ...
    able to collaborate among themselves. A family of products may have several variants,
...
class ConcreteFactory1(AbstractFactory):
    ...
    variant. The factory guarantees that resulting products are compatible. Note that
